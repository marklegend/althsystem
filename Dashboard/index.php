...
<div class="content-wrapper">
  ...
  <section class="content container-fluid">
            ...
            <div class="box box-info">
                ...
                <h3 class="box-title">Todays clients birthdays</h3>
         ...
         <div class="col-md-6 ">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                <h3 class="box-title">Min level Stock</h3>
                ...
                <div class="box-body">
                <div class="table-responsive">
                    <table id="minlvls" class="table table-bordered table-striped no-margin">
                    <thead>
                    <tr>
                        <th>Supplement </th>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                <h3 class="box-title">Top Selling Months</h3>
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                <h3 class="box-title">Quick Client Contact info</h3>
                ...
                <div class="box-body">
                <div class="table-responsive">
                    <table id="contacts" class="table table-bordered table-striped no-margin">
                    <thead>
                    <tr>
                       <th>Client </th>    
                       <th>Home</th>
